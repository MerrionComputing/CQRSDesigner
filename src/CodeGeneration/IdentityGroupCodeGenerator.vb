...
Public Class IdentityGroupCodeGenerator
    ...
    Public Function GenerateInterface() As CodeCompileUnit Implements IEntityCodeGenerator.GenerateInterface
        ...
        ' Make the interface inherit Interface CQRSAzure.IdentifierGroup.IIdentifierGroup(Of TAggregate As IAggregationIdentifier, TKey)
        Dim parentAggregateInterface As CodeTypeReference = InterfaceCodeGeneration.ImplementsInterfaceReference(m_identitygroup.AggregateIdentifier.Name)
        Dim genericEventInterface As CodeTypeReference = InterfaceCodeGeneration.ImplementsGenericInterfaceReference("CQRSAzure.IdentifierGroup.IIdentifierGroup", {parentAggregateInterface})
    ...
    Public Function GenerateImplementation() As CodeCompileUnit Implements IEntityCodeGenerator.GenerateImplementation
        ...
        emptyConstructor.Attributes = (emptyConstructor.Attributes And (Not MemberAttributes.AccessMask)) Or MemberAttributes.Public
