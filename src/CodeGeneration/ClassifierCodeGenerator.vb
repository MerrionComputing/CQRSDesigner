...
Public Class ClassifierCodeGenerator
    ...
    Private Shared Function MakeConditionalEvaluation(propertyEvaluationToPerform As PropertyEvaluation,
                                                      sourcePropertyType As PropertyDataType,
                                                      target As String,
                                                      targetType As EvaluationTargetType,
                                                      ifThenElse As CodeConditionStatement,
                                                      sourceReference As CodeFieldReferenceExpression) As CodeConditionStatement
