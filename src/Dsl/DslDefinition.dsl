...
<Dsl xmlns:dm0="http://schemas.microsoft.com/VisualStudio/2008/DslTools/Core" dslVersion="1.0.0.0" Id="2bad020f-9a7d-4ffa-8cc1-6050f57b0191" Description="Domain Specific Language for creating CQRS/ES domains" Name="CQRSdsl" DisplayName="CQRSdsl" Namespace="CQRSAzure.CQRSdsl.Dsl" MinorVersion="2" ProductName="CQRSdsl" CompanyName="CQRSAzure" PackageGuid="5f54fc41-4897-47e5-b71f-8ff66160144e" PackageNamespace="CQRSAzure.CQRSdsl.Dsl" xmlns="http://schemas.microsoft.com/VisualStudio/2005/DslTools/DslDefinitionModel">
  ...
  <Classes>
    <DomainClass Id="b927fa6e-0562-44cc-9be0-71281aa07d25" Description="The root in which all other elements are embedded. Appears as a diagram." Name="CQRSModel" DisplayName="CQRSModel" Namespace="CQRSAzure.CQRSdsl.Dsl" HasCustomConstructor="true">
      ...
      <Properties>
        ...
        <DomainProperty Id="b9d82f95-2eb4-49d6-af01-7b17fceaa8ef" Description="Should the additional scaffold required to host this domain on Azure Event Grid be generated" Name="GenerateEventGridSupportingCode" DisplayName="Generate Event Grid Supporting Code" DefaultValue="False" Category="Code Generation">
          <Type>
            <ExternalTypeMoniker Name="/System/Boolean" />
          </Type>
        </DomainProperty>
        <DomainProperty Id="534d2e3f-8a4b-4d8b-a119-4c3433ff7308" Description="How type-safe should the underlying code generation " Name="TypedCodeGeneration" DisplayName="Typed Code Generation">
          <Notes>For Azure Functions this has to be JSOn as type-serialisers cannot work</Notes>
          <Type>
            <DomainEnumerationMoniker Name="TypedGenerationSetting" />
          </Type>
        </DomainProperty>
      </Properties>
    ...
    <DomainClass Id="5a0a5db7-8b56-49a4-afc4-51b42ad2e058" Description="An operation to perform on a projection property when an event is handled by the projection" Name="ProjectionEventPropertyOperation" DisplayName="Projection Event Property Operation" Namespace="CQRSAzure.CQRSdsl.Dsl">
      ...
      <Properties>
        ...
        <DomainProperty Id="7714d198-2b48-49c1-8fa1-233e1a404bcb" Description="A constant that can be used in place of the source field in this operation" Name="SourceConstant" DisplayName="Source Constant">
          <Notes>This is stored as a string but needs to be convertible into whatever the target property data type is</Notes>
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
      ...
      <Properties>
        ...
        <DomainProperty Id="552c895d-1074-48f8-98ab-1c6e0dd21247" Description="The name of the group of which this group is a wholy contained subset" Name="ParentName" DisplayName="Parent Name" DefaultValue="All">
          <Attributes>
            <ClrAttribute Name="System.ComponentModel.Editor">
              <Parameters>
                <AttributeParameter Value="typeof(CQRSAzure.CQRSdsl.Dsl.CustomCode.UI.IdentifierGroupNameUITypeEditor)" />
                <AttributeParameter Value="typeof(System.Drawing.Design.UITypeEditor)" />
              </Parameters>
            </ClrAttribute>
          </Attributes>
  ...
  <Relationships>
    ...
    <DomainRelationship Id="05477329-76e7-4b3a-b817-03642eaecf6b" Description="For a classifier that relies on a projection, this is the projection concerned" Name="ClassifierReferencesProjectionDefinition" DisplayName="Classifier References Projection Definition" Namespace="CQRSAzure.CQRSdsl.Dsl">
      ...
      <Target>
        <DomainRole Id="b5f11c71-dbde-4508-b100-91d44c9dd6e6" Description="Description for CQRSAzure.CQRSdsl.Dsl.ClassifierReferencesProjectionDefinition.ProjectionDefinition" Name="ProjectionDefinition" DisplayName="Projection Definition" PropertyName="Classifiers" PropertyDisplayName="Classifiers">
          <RolePlayer>
            <DomainClassMoniker Name="ProjectionDefinition" />
          </RolePlayer>
        </DomainRole>
  ...
  <Types>
    ...
    <DomainEnumeration Name="TypedGenerationSetting" Namespace="CQRSAzure.CQRSdsl.Dsl" Description="Description for CQRSAzure.CQRSdsl.Dsl.TypedGenerationSetting">
      <Notes>Allows for generating strongly typed or untyped (JSON based) classes</Notes>
      <Literals>
        <EnumerationLiteral Description="Generate strongly-typed .NET classes" Name="StronglyTyped" Value="0" />
        <EnumerationLiteral Description="Generate untyped JSON style event code" Name="UntypedJSON" Value="1">
          <Notes>This is required for hosting on Azure Functions </Notes>
        </EnumerationLiteral>
      </Literals>
    </DomainEnumeration>
  </Types>
    ...
    <ClassData>
      <XmlClassData TypeName="CQRSModel" MonikerAttributeName="" SerializeId="true" MonikerElementName="cQRSModelMoniker" ElementName="cQRSModel" MonikerTypeName="CQRSModelMoniker">
        ...
        <ElementData>
          ...
          <XmlPropertyData XmlName="generateEventGridSupportingCode">
            <DomainPropertyMoniker Name="CQRSModel/GenerateEventGridSupportingCode" />
          </XmlPropertyData>
          <XmlPropertyData XmlName="typedCodeGeneration">
            <DomainPropertyMoniker Name="CQRSModel/TypedCodeGeneration" />
          </XmlPropertyData>
        </ElementData>
      </XmlClassData>
      ...
      <XmlClassData TypeName="ProjectionEventPropertyOperation" MonikerAttributeName="" SerializeId="true" MonikerElementName="projectionEventPropertyOperationMoniker" ElementName="projectionEventPropertyOperation" MonikerTypeName="ProjectionEventPropertyOperationMoniker">
        ...
        <ElementData>
          ...
          <XmlPropertyData XmlName="sourceConstant">
            <DomainPropertyMoniker Name="ProjectionEventPropertyOperation/SourceConstant" />
          </XmlPropertyData>
        </ElementData>
      </XmlClassData>
