namespace CQRSAzure.CQRSdsl.CustomCode.Interfaces
{
    ...
    public interface IModelCodeGenerationOptions
    {
        ...
        /// <summary>
        /// How should events be serialised to the event stream
        /// </summary>
        ModelCodegenerationOptionsBase.TypedCodeGenerationSetting TypedCodeGeneration { get; }
        ...
        /// technology
        /// </summary>
        bool GenerateEventGridSupportingCode { get; }
    }
    ...
    public static class ModelCodegenerationOptionsBase
    {
        ...
        /// <summary>
        /// What way should serialisation of the events and snapshots be done
        /// </summary>
        public enum TypedCodeGenerationSetting
        {
            /// <summary>
            /// Persist objects using strongly typed .NET serialisation
            /// </summary>
            StronglyTyped = 0,
            /// <summary>
            /// Persist objects using weaker/untyped JSON serialisation
            /// </summary>
            UntypedJSON = 1
        }
    }
